...
import pf.friends.adapter.ImageScaleAdapter;
import pf.friends.bean.EaluationListBean;
import pf.friends.utils.CommonUtils;
import pf.friends.utils.EvaluateUtil;
import pf.friends.view.HackyViewPager;
import pf.friends.view.material.MaterialTextView;
import pf.friends.view.photoview.PhotoView;
import pf.pf.R;


/**
 * 查看图片时
 * ImageScaleAdapter具体图片页面，长嗯图片下载
 * 图片左右旋转被我隐藏了
 */
